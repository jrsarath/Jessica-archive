...
if ("undefined" != typeof jessicaVoice)
    ...
    var jessicaVoice = function() {
        ...
        a.getVoices = function() {
            for (var b = [], c = 0; c < a.jessicaVoices.length; c++)
                b.push({
                ...
                if (a.isPlaying())
                    ...
                    if (b.length > a.CHARACTER_LIMIT) {
                        for (var f = b; f.length > a.CHARACTER_LIMIT; ) {
                            ...
                            if (-1 == g || g >= a.CHARACTER_LIMIT) {
                                var l = f.split(" ");
                                for (g = 0; g < l.length && !(e.length + l[g].length + 1 > a.CHARACTER_LIMIT); g++)
                                    e += (0 != g ? " " : "") + l[g]
                            } else
                                e = f.substr(0, g + 1);
        ...
        ;
        a.mapRVs = function() {
            for (var b = 0; b < a.jessicaVoices.length; b++)
                for (var c = a.jessicaVoices[b], d = 0; d < c.voiceIDs.length; d++) {
        ...
        a.getjessicaVoice = function(b) {
            for (var c = 0; c < a.jessicaVoices.length; c++)
                if (a.jessicaVoices[c].name == b)
                    return b = a.fallbackMode,
                    a.fallbackMode = !0 === a.jessicaVoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.forcedFallbackMode ? !0 : !1,
